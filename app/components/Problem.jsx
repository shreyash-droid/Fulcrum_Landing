export default function Problem({ v2 = false }) {
  const cardClass = v2 ? "problem-card problem-card--flat reveal" : "problem-card reveal";
  return (
      ...
      <div className="container">
        <div className="section-head reveal">
          ...
          <h2>
            {v2 ? (
              <>
                You know their face. You <em>just</em> don&rsquo;t know their names.
              </>
            ) : (
              <>
        ...
        <div className="grid-3">
          ...
          <div className={cardClass} style={{ transitionDelay: ".06s" }}>
            <div className="icon-tile">
              <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className={cardClass} style={{ transitionDelay: ".12s" }}>
            <div className="icon-tile">
              <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
