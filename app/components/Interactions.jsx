...
/* ============================================================
   ...
   unobserved.
   ============================================================ */
/* Static feature-tab data + pure renderers. Hoisted to module scope so they
   are allocated once, not rebuilt on every route change inside the effect.
   Pure functions of their arguments — identical output to before. */
